...
public class ModalWindowUtils
{
    ...
    public static void makeModalWindowMethod(final AnalysisData data, final String title, final String content,
            final String button, final String buttonMethod)
    {
        ...
        s.append("            <div>\n");
        s.append("              <form action=\"/housinggame-analysis/analysis\" method=\"post\">\n");
    ...
    public static void make2ButtonModalWindow(final AnalysisData data, final String title, final String content,
    ...
    public static void makeErrorModalWindow(final AnalysisData data, final String title, final String content)
    {
        StringBuilder s = new StringBuilder();
        s.append("  <div class=\"hg-modal\">\n");
        s.append("    <div class=\"hg-modal-window\" id=\"hg-modal-window\">\n");
